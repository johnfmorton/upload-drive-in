...
return [
    ...
    's3_disconnect_confirmation' => 'Êtes-vous sûr de vouloir déconnecter Amazon S3 ? Cela supprimera tous les identifiants stockés.',
    ...
    // S3 Form Labels
    's3_access_key_id_label' => 'ID de Clé d\'Accès AWS',
    's3_access_key_id_hint' => 'Doit être exactement 20 caractères alphanumériques majuscules',
    's3_secret_access_key_label' => 'Clé d\'Accès Secrète AWS',
    's3_secret_access_key_hint' => 'Doit être exactement 40 caractères. Laissez vide pour conserver la clé secrète existante.',
    's3_region_label' => 'Région AWS',
    's3_region_hint' => 'Sélectionnez la région AWS où se trouve votre bucket S3',
    's3_region_select_prompt' => 'Sélectionnez une région',
    's3_bucket_name_label' => 'Nom du Bucket S3',
    's3_bucket_name_hint' => 'Le nom du bucket doit contenir 3-63 caractères, lettres minuscules, chiffres, tirets et points uniquement',
    's3_endpoint_label' => 'Point de Terminaison Personnalisé (Optionnel)',
    's3_endpoint_hint' => 'Pour les services compatibles S3 comme Cloudflare R2, Backblaze B2 ou MinIO. Laissez vide pour AWS S3 standard.',
    
    // S3 Connection Testing
    's3_test_connection' => 'Tester la Connexion',
    's3_testing_connection' => 'Test en cours...',
    's3_connection_test_successful' => 'Connexion réussie !',
    's3_connection_test_failed' => 'Échec du test de connexion. Veuillez vérifier vos identifiants et réessayer.',
    
    // S3 Configuration Actions
    's3_save_configuration' => 'Enregistrer la Configuration',
    's3_saving_configuration' => 'Enregistrement...',
    's3_configuration_saved_and_verified' => 'Configuration S3 enregistrée et connexion vérifiée avec succès.',
    's3_configuration_saved_but_connection_failed' => 'Configuration S3 enregistrée mais la connexion a échoué : :error',
    's3_configuration_saved_but_health_check_failed' => 'Configuration S3 enregistrée mais la vérification de santé a échoué. Veuillez vérifier vos paramètres.',
    's3_configuration_save_failed' => 'Échec de l\'enregistrement de la configuration S3. Veuillez réessayer.',
    's3_configuration_update_failed' => 'Échec de la mise à jour de la configuration S3. Veuillez réessayer.',
    
    // S3 Validation Messages
    's3_access_key_id_format_invalid' => 'L\'ID de clé d\'accès AWS doit être exactement 20 caractères alphanumériques majuscules.',
    's3_secret_access_key_length_invalid' => 'La clé d\'accès secrète AWS doit être exactement 40 caractères.',
    ...
    's3_environment_configuration' => 'Configuration d\'Environnement',
    's3_environment_settings_notice' => 'Certains paramètres Amazon S3 sont configurés via des variables d\'environnement et ne peuvent pas être modifiés ici :',
    's3_env_aws_access_key_id' => 'ID de Clé d\'Accès AWS',
    's3_env_aws_secret_access_key' => 'Clé d\'Accès Secrète AWS',
    's3_env_aws_region' => 'Région AWS',
    's3_env_s3_bucket_name' => 'Nom du Bucket S3',
    's3_env_custom_endpoint' => 'Point de Terminaison Personnalisé',
    's3_env_configured_via_environment' => 'Cette valeur est configurée via des variables d\'environnement.',
    ...
    's3_access_key_length_error' => 'L\'ID de Clé d\'Accès doit contenir exactement 20 caractères',
    's3_access_key_format_error' => 'L\'ID de Clé d\'Accès ne doit contenir que des lettres majuscules et des chiffres',
    ...
    's3_secret_key_length_error' => 'La Clé d\'Accès Secrète doit contenir exactement 40 caractères',
    ...
    's3_region_format_error' => 'Format de région invalide',
    's3_region_format_invalid' => 'Format de région invalide',
    's3_bucket_required' => 'Le nom du bucket est requis',
    's3_bucket_length_error' => 'Le nom du bucket doit contenir entre 3 et 63 caractères',
    's3_bucket_format_error' => 'Le nom du bucket doit commencer et se terminer par une lettre ou un chiffre, et ne contenir que des lettres minuscules, des chiffres, des tirets et des points',
    ...
    's3_endpoint_format_error' => 'Le point de terminaison doit être une URL valide commençant par http:// ou https://',
    's3_connection_test_failed_message' => 'Échec du test de connexion. Veuillez réessayer.',
    ...
    's3_env_configuration_title' => 'Configuration d\'Environnement',
    's3_env_configuration_message' => 'Certains paramètres Amazon S3 sont configurés via des variables d\'environnement et ne peuvent pas être modifiés ici :',
    's3_env_access_key_id' => 'ID de Clé d\'Accès AWS',
    's3_env_secret_access_key' => 'Clé d\'Accès Secrète AWS',
    ...
    's3_js_access_key_length' => 'L\'ID de Clé d\'Accès doit contenir exactement 20 caractères',
    's3_js_access_key_format' => 'L\'ID de Clé d\'Accès ne doit contenir que des lettres majuscules et des chiffres',
    's3_js_secret_key_required' => 'La Clé d\'Accès Secrète est requise',
    's3_js_secret_key_length' => 'La Clé d\'Accès Secrète doit contenir exactement 40 caractères',
    's3_js_region_required' => 'La région est requise',
    's3_js_region_format' => 'Format de région invalide',
    's3_js_bucket_required' => 'Le nom du bucket est requis',
    's3_js_bucket_length' => 'Le nom du bucket doit contenir entre 3 et 63 caractères',
    's3_js_bucket_format' => 'Le nom du bucket doit commencer et se terminer par une lettre ou un chiffre, et ne contenir que des lettres minuscules, des chiffres, des tirets et des points',
    's3_js_bucket_consecutive_periods' => 'Le nom du bucket ne peut pas contenir de points consécutifs',
    's3_js_bucket_ip_format' => 'Le nom du bucket ne peut pas être formaté comme une adresse IP',
    's3_js_endpoint_format' => 'Le point de terminaison doit être une URL valide commençant par http:// ou https://',
    's3_js_connection_test_failed' => 'Échec du test de connexion',
    's3_js_connection_test_error' => 'Échec du test de connexion. Veuillez réessayer.',
    ...
    'welcome_message_intro' => 'Félicitations ! Votre application Upload Drive-in a été installée avec succès.',
    ...
    'welcome_message_step_security_settings' => 'Examinez les paramètres de sécurité et le contrôle d\'accès.',
    ...
    'welcome_message_step_create_employees' => 'Optionnellement, créez des comptes employés pour les membres de l\'équipe',
