<?php return [
    ...
    'app_icon_hint' => 'Upload a PNG, JPG, or SVG. Recommended size: 600x125px, but there is no required size.',
    'current_app_icon_alt' => 'Current Application Icon',
    'save_button' => 'Save',
    ...
    'welcome_message_step_create_employees' => 'Optionally, create employee accounts for team members',
    'welcome_message_button_cloud_storage' => 'Cloud Storage Settings',
    'welcome_message_button_security' => 'Security and Access Settings',
    'welcome_message_button_employees' => 'Manage Employees',
    'welcome_message_button_settings' => 'Branding Settings',
    ...
    'button_create_user_loading' => 'Creating User...',
    ...
    'button_create_and_invite_loading' => 'Creating & Sending...',
    ...
    's3_env_access_key_id' => 'AWS Access Key ID',
    's3_env_secret_access_key' => 'AWS Secret Access Key',
    ...
    's3_js_access_key_length' => 'Access Key ID must be exactly 20 characters',
    's3_js_access_key_format' => 'Access Key ID must contain only uppercase letters and numbers',
    's3_js_secret_key_required' => 'Secret Access Key is required',
    's3_js_secret_key_length' => 'Secret Access Key must be exactly 40 characters',
    's3_js_region_required' => 'Region is required',
    's3_js_region_format' => 'Invalid region format',
    's3_js_bucket_required' => 'Bucket name is required',
    's3_js_bucket_length' => 'Bucket name must be between 3 and 63 characters',
    's3_js_bucket_format' => 'Bucket name must start and end with a letter or number, and contain only lowercase letters, numbers, hyphens, and periods',
    's3_js_bucket_consecutive_periods' => 'Bucket name cannot contain consecutive periods',
    's3_js_bucket_ip_format' => 'Bucket name cannot be formatted as an IP address',
    's3_js_endpoint_format' => 'Endpoint must be a valid URL starting with http:// or https://',
    's3_js_connection_test_failed' => 'Connection test failed',
    's3_js_connection_test_error' => 'Failed to test connection. Please try again.',
    ...
    's3_configure_aws_credentials' => 'Configure AWS credentials for system-wide S3 storage',
    's3_environment_configuration' => 'Environment Configuration',
    's3_environment_settings_notice' => 'Some Amazon S3 settings are configured via environment variables and cannot be edited here:',
    's3_env_aws_access_key_id' => 'AWS Access Key ID',
    's3_env_aws_secret_access_key' => 'AWS Secret Access Key',
    's3_env_aws_region' => 'AWS Region',
    's3_env_s3_bucket_name' => 'S3 Bucket Name',
    's3_env_custom_endpoint' => 'Custom Endpoint',
    's3_env_configured_via_environment' => 'This value is configured via environment variables.',
    ...
    's3_select_region' => 'Select a region',
    's3_access_key_format' => 'Must be exactly 20 uppercase alphanumeric characters',
    's3_secret_key_format' => 'Must be exactly 40 characters. Leave blank to keep existing secret key.',
    's3_region_help' => 'Select the AWS region where your S3 bucket is located',
    's3_bucket_name_format' => 'Bucket name must be 3-63 characters, lowercase letters, numbers, hyphens, and periods only',
    's3_custom_endpoint_help' => 'For S3-compatible services like Cloudflare R2, Backblaze B2, or MinIO. Leave blank for standard AWS S3.',
    's3_test_connection' => 'Test Connection',
    's3_testing' => 'Testing...',
    's3_connection_successful' => 'Connection successful!',
    's3_saving' => 'Saving...',
    's3_access_key_required' => 'Access Key ID is required',
    's3_access_key_length_error' => 'Access Key ID must be exactly 20 characters',
    's3_access_key_format_error' => 'Access Key ID must contain only uppercase letters and numbers',
    's3_secret_key_required' => 'Secret Access Key is required',
    's3_secret_key_length_error' => 'Secret Access Key must be exactly 40 characters',
    's3_region_required' => 'Region is required',
    's3_region_format_error' => 'Invalid region format',
    's3_bucket_required' => 'Bucket name is required',
    's3_bucket_length_error' => 'Bucket name must be between 3 and 63 characters',
    's3_bucket_format_error' => 'Bucket name must start and end with a letter or number, and contain only lowercase letters, numbers, hyphens, and periods',
    ...
    's3_endpoint_format_error' => 'Endpoint must be a valid URL starting with http:// or https://',
    's3_connection_test_failed_message' => 'Failed to test connection. Please try again.',
    ...
    's3_us_west_california' => 'US West (N. California)',
    's3_us_west_oregon' => 'US West (Oregon)',
    's3_canada_central' => 'Canada (Central)',
    's3_eu_ireland' => 'EU (Ireland)',
    's3_eu_london' => 'EU (London)',
    's3_eu_paris' => 'EU (Paris)',
    's3_eu_frankfurt' => 'EU (Frankfurt)',
    's3_eu_stockholm' => 'EU (Stockholm)',
    's3_asia_mumbai' => 'Asia Pacific (Mumbai)',
    's3_asia_tokyo' => 'Asia Pacific (Tokyo)',
    's3_asia_seoul' => 'Asia Pacific (Seoul)',
    's3_asia_osaka' => 'Asia Pacific (Osaka)',
