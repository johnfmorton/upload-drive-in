...
return [
    ...
    's3_custom_endpoint' => 'Benutzerdefinierter Endpunkt (Optional)',
    's3_select_region' => 'Wählen Sie eine Region',
    's3_access_key_format' => 'Muss genau 20 alphanumerische Großbuchstaben sein',
    's3_secret_key_format' => 'Muss genau 40 Zeichen lang sein. Leer lassen, um den vorhandenen geheimen Schlüssel beizubehalten.',
    's3_region_help' => 'Wählen Sie die AWS-Region, in der sich Ihr S3-Bucket befindet',
    's3_bucket_name_format' => 'Bucket-Name muss 3-63 Zeichen lang sein, nur Kleinbuchstaben, Zahlen, Bindestriche und Punkte',
    's3_custom_endpoint_help' => 'Für S3-kompatible Dienste wie Cloudflare R2, Backblaze B2 oder MinIO. Leer lassen für Standard-AWS S3.',
    's3_test_connection' => 'Verbindung testen',
    's3_testing' => 'Teste...',
    's3_connection_successful' => 'Verbindung erfolgreich!',
    's3_saving' => 'Speichere...',
    ...
    's3_us_west_california' => 'USA West (N. Kalifornien)',
    's3_us_west_oregon' => 'USA West (Oregon)',
    's3_canada_central' => 'Kanada (Zentral)',
    's3_eu_ireland' => 'EU (Irland)',
    's3_eu_london' => 'EU (London)',
    's3_eu_paris' => 'EU (Paris)',
    's3_eu_frankfurt' => 'EU (Frankfurt)',
    's3_eu_stockholm' => 'EU (Stockholm)',
    's3_asia_mumbai' => 'Asien-Pazifik (Mumbai)',
    's3_asia_tokyo' => 'Asien-Pazifik (Tokio)',
    's3_asia_seoul' => 'Asien-Pazifik (Seoul)',
    's3_asia_osaka' => 'Asien-Pazifik (Osaka)',
    ...
    'file_manager_no_user_for_s3_delete' => 'Kein Benutzer verfügbar, um Datei von S3 zu löschen',
    'file_manager_no_google_drive_connection_for_delete' => 'Keine Google Drive-Verbindung zum Löschen von Dateien verfügbar. Bitte stellen Sie sicher, dass ein Administrator sein Google Drive-Konto verbunden hat.',
    'file_manager_no_files_for_download' => 'Keine Dateien zum Herunterladen gefunden.',
    'file_manager_zip_creation_failed' => 'ZIP-Archiv kann nicht erstellt werden: :error',
    'file_manager_no_files_added_to_zip' => 'Keine Dateien konnten zum Archiv hinzugefügt werden. Alle Dateien können im Cloud-Speicher gespeichert oder nicht zugänglich sein.',
];