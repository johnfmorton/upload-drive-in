...
MAIL_FROM_ADDRESS=name@example.com</code></pre>
                        ...
                        <div class="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-3 space-y-2 sm:space-y-0">
                                <h3 class="text-md font-medium text-blue-900">Test Email Configuration</h3>
                            </div>
                            <p class="text-sm text-blue-700 mb-4">
                                After configuring your mail settings, send a test email to verify everything works correctly.
                            </p>

                            <div class="flex flex-col sm:flex-row gap-3">
                                <div class="flex-1">
                                    <label for="test-email-address" class="sr-only">Email address</label>
                                    <input type="email" id="test-email-address" name="test_email"
                                        placeholder="Enter your email address"
                                        value="{{ config('mail.from.address') !== 'hello@example.com' ? config('mail.from.address') : '' }}"
                                ...
                                <button id="test-email-btn"
                                    ...
                                    <div id="test-email-spinner" class="loading-spinner hidden ml-2"></div>
                                </button>
                            </div>

                            <!-- Test Email Results -->
                            <div id="email-test-results" class="hidden mt-4">
                                <!-- Success Message -->
                                <div id="email-test-success" class="hidden bg-green-50 border border-green-200 rounded-lg p-3">
                                    <div class="flex items-start">
                                        ...
                                        <div class="flex-1">
                                            <h4 class="text-sm font-medium text-green-800">Test Email Sent</h4>
                                            <p id="email-test-success-message" class="text-sm text-green-700 mt-1"></p>
                                        </div>
                                    </div>
                                </div>

                                <!-- Error Message -->
                                <div id="email-test-error" class="hidden bg-red-50 border border-red-200 rounded-lg p-3">
                                    <div class="flex items-start">
                                        ...
                                        <div class="flex-1">
                                            <h4 class="text-sm font-medium text-red-800" id="email-test-error-title">Test Failed</h4>
                                            <p id="email-test-error-message" class="text-sm text-red-700 mt-1"></p>
                                            <div id="email-test-troubleshooting" class="hidden mt-3">
                                                <details class="text-xs">
                                                    <summary class="cursor-pointer font-medium text-red-800 hover:text-red-900">Troubleshooting Steps</summary>
                                                    <ul id="email-test-troubleshooting-list" class="mt-2 space-y-1 pl-4 text-red-700 list-disc list-inside">
                                                    </ul>
                                                </details>
                                            </div>
                                        </div>
