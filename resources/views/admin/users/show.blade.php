                ...
                <div class="p-6">
                    ...
                    <div x-show="activeTab === 'team'" x-transition 
                        ...
                        <form method="POST" action="{{ route('admin.users.team.update', $client->id) }}">
                            ...
                            <div class="space-y-6">
                                <div>
                                    <h3 class="text-lg font-medium text-gray-900 mb-4">{{ __('messages.assign_team_members') }}</h3>
                                    <p class="text-sm text-gray-600 mb-4">
                                        {{ __('messages.select_team_members_help') }}
                                    </p>
                                </div>
                                ...
                                <div class="flex justify-end">
                                    <button type="submit" 
                                        ...
                                        {{ __('messages.update_team_access') }}
                                    </button>
                                </div>
                            </div>
                        </form>
