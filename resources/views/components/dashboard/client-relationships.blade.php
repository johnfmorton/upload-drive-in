            ...
            <div class="flex items-center">
                <div class="w-10 h-10 bg-green-100 rounded-lg flex items-center justify-center mr-4">
                    <svg class="h-6 w-6 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.02,16.98H1.16v-1.16c0-3.83,3.1-6.93,6.93-6.93s6.93,3.1,6.93,6.93v1.16ZM16.17,16.98h6.93v-1.16c0-3.83-3.1-6.93-6.93-6.93-1.22,0-2.41.32-3.47.93M12.13,4.73c0,1.97-1.6,3.57-3.57,3.57s-3.57-1.6-3.57-3.57h0c0-1.97,1.6-3.57,3.57-3.57s3.57,1.6,3.57,3.57ZM19.85,4.73c0,1.97-1.6,3.57-3.57,3.57s-3.57-1.6-3.57-3.57h0c0-1.97,1.6-3.57,3.57-3.57s3.57,1.6,3.57,3.57Z"></path>
                    </svg>
                </div>
                <div>
