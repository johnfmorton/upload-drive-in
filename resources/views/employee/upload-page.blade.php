            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <div class="border rounded-lg p-6">
                        ...
                        <form method="POST" action="{{ route('employee.upload', ['username' => $user->username]) }}" enctype="multipart/form-data">
                            @csrf
                                    ...
                                    @foreach($recentUploads as $upload)
                                        <div class="p-4 flex items-center justify-between">
                                            <div>
                                                ...
                                                @if($upload->message)
                                                    <div class="text-sm text-gray-600 mt-1">{{ $upload->message }}</div>
                                                @endif
                                            </div>
                                            <div class="text-sm">
