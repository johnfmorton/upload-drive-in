...
### Fixed
- Tall images in file preview modal were cropped instead of scaling down to fit the available space

[1.2.1]: https://github.com/johnfmorton/upload-drive-in/releases/tag/v1.2.1
