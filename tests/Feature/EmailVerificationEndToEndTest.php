 ...
 */
class EmailVerificationEndToEndTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function admin_user_creation_sends_client_verification_email_end_to_end()
    {
        ...
        $this->assertStringContainsString('login/token', $verificationUrl);
        ...
        $verificationResponse->assertRedirect(route('client.dashboard'));
    }
